<template>
  <div class="container p-2">
    ...
    <div class="mt-3">
      <p>Berdirinya ASEAN dipelopori oleh 5 negara di Asia Tenggara. Siapakah negara pendiri ASEAN ?</p>
    </div>
    <div class="mt-4">
      <button class="pilih d-flex align-items-center container" :disabled="isDisabled" :style="{backgroundColor : warna.a}" @click="salah('a')">
        ...
        <p class="kalimat d-flex align-items-center" :style="{color : warni.a}">
          Filipina, Vietnam, Laos, Indoensia, Singapura
        </p>
      </button>
    </div>
    <div class="mt-4">
    ...
    <div class="hilang justify-content-end mt-4 mb-4" :style="{display : lanjut}">
      <NuxtLink to="/soal/10" class="next">
        <h2 class="neks">
          Selanjutnya
        </h2>
      </NuxtLink>
